...
import {Row, Col,Button,Form,Dropdown,Badge,Card,Table} from "react-bootstrap"
              ...
              <div>
                <Row className="d-flex justify-content-center">
                  <Col lg={11}>
                    ...
                    <div className="d-flex flex-row justify-content-between m-0 p-0">
                      <p className="mb-2">Trannsaction Type</p>
    ...
    <Row className="ps-0 mx-4 " style={{ border: "1px solid #e0e0e1" }}>
      <Col className="ps-0">
        ...
        <Button
          ...
          style={{ borderRadius: 0, backgroundColor: "#206AA2" }}
        >
          All <Badge className="bg-white text-primary rounded-0">3</Badge>
        </Button>
      </Col>
      <Col>
        {" "}
        <Button className="bg-white text-black w-100 border-0 py-3">
          Processed
        </Button>
      </Col>
      <Col>
        ...
        return (
          <tr className="py-2 m-0 h6 align-items-center " key={index}>
            ...
            <button className="viewButton text-white rounded p-2 my-2">
              <img src={IMAGES.eye} alt="eye" /> View
            </button>
          </tr>
        );
      })}
